...
public class BsRoleController {
	...
	private Logger logger = LogManager.getLogger(BsRoleController.class.getName());

	@Resource(name="bsRoleService")
	private BsRoleService service;
	
	
	@RequestMapping(value = "/select.do", method = RequestMethod.POST)
	public @ResponseBody Object selectByExample(BsRoleVo vo,HttpServletRequest request) {		
		PageOutVo<BsRolePo> list=service.selectByExample(vo);		
	...
	public @ResponseBody Object insert(@RequestBody BsRolePo po) {		
	...
	public @ResponseBody Object update(@RequestBody BsRolePo po) {
