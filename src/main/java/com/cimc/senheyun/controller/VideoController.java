...
public class VideoController {
	...
	private Logger logger = LogManager.getLogger(VideoController.class.getName());
	@Resource(name="videoService")
	private VideoService service;

	// 查询信息
	@RequestMapping(value = "/selectToken", method = RequestMethod.POST)
	public @ResponseBody Object selectToken(@RequestBody VdTokenVo vo,HttpServletRequest request) {
		...
		PageOutVo<VdTokenPo> list=service.selectToken(vo);		
